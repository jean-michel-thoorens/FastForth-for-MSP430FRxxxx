...
@echo     so config files.pat for the preprocessor gema.exe are in the folder \inc
@echo     and batch file are in the folder \config
@echo you have installed the last version of teraterm,
@echo you have installed the last version of gema.exe in the folder \prog.
@echo.
@echo edit properties of these three links SendSourceFileToTarget.bat, CopySourceFileToTarget_SD_Card.bat and
@echo PreprocessSourceFile.f.bat to change the drive letter as yours.
@echo.
@exit /B
