...
! 1C00-1FFF = RAM (1 KB)
! E000-FF7F = code memory (FRAM 8064 B)
...
! FRAM MAIN
! ============================================
MAIN_ORG=\$E000!        Code space start
MAIN_LEN=\$2000!        8 k FRAM
! ----------------------------------------------
...
XPLOOP=\$E05C! 
XLOOP=\$E06E! 
MUSMOD=\$E074!          unsigned 32/16 division
SETIB=\$E0BA!           Set Input Buffer with org len values, reset >IN 
REFILL=\$E0CA!          accept one line from input and leave org len of input buffer
CIB_ADR=\$E0D8!         contents currently TIB_ORG; may be redirected to SDIB_ORG
XDODOES=\$E0E2!         restore rDODOES: MOV #XDODOES,rDODOES
XDOCON=\$E0F0!          restore rDOCON: MOV #XDOCON,rDOCON
XDOCOL=\$E0FC!          restore rDOCOL: MOV #XDOCOL,rDOCOL      only for DTC model = 1
